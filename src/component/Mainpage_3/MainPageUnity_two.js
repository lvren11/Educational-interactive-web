...
import tabledata  from '../../../mock/data/exdata_3.json';
...
const unityContext = new UnityContext({
  loaderUrl: "/Third/Page4/Build/Buildfile.loader.js", // public下目录
  dataUrl: "/Third/Page4/Build/Buildfile.data",
  frameworkUrl: "/Third/Page4/Build/Buildfile.framework.js",
  codeUrl: "/Third/Page4/Build/Buildfile.wasm",
  streamingAssetsUrl: "/Third/Page4/StreamingAssets",
 });
...
export default function MainPageUnity(props) {
  ...
  const [table_data,settabledata] = React.useState(tabledata[1]);
  const [inputv, setinputv] = useState({"1":"","2":"","3":"","4":"","5":"","6":""});
  let dicttoname = {"1":"第一个下划线","2":"第二个下划线","3":"第三个下划线","4":"第四个下划线"};
