...
export default function MainPageUnity(props) {
  ...
  let dicttoname = {"4":"A","5":"B","6":"C","7":"D","8":"E","9":"F",};
                    ...
                    {( ()=>{
                          switch(data.maincontent[curpage - 2].type){
                              ...
                              case 2:return (
                                ...
                                <Grid item xs={12} sm={6}>
                                <div className={classes.paper2}>E:
                                <FormControl className={classes.formControl}>
                                  <NativeSelect
                                    value={age[String(curpage+4)]}
                                    onChange={handleChange}
                                    name={String(curpage+4)}
                                    className={classes.selectEmpty}
                                    input={<BootstrapInput />}
                                  >
                                    <option value="">下拉选择</option>
                                ...
                                <Grid item xs={12} sm={6}>
                                <div className={classes.paper2}>F:
                                <FormControl className={classes.formControl}>
                                  <NativeSelect
                                    value={age[String(curpage+5)]}
                                    onChange={handleChange}
                                    name={String(curpage+5)}
                                    className={classes.selectEmpty}
                                    input={<BootstrapInput />}
                                  >
                                    <option value="">下拉选择</option>
