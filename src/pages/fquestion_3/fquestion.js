...
import Intro from '../../component/Mainpage_3/introduce';
import MainPage from '../../component/Mainpage_3/mainpage';
import MainPageUnity from '../../component/Mainpage_3/mainpageunity.js';
import MainPageUnitytwo from '../../component/Mainpage_3/MainPageUnity_two.js';
import MainPageUnitythree from '../../component/Mainpage_3/MainPageUnity_three.js';
import data from '../../../mock/data/third.json';
...
export default function Fquestion() {
  ...
  const handleNext = (page) => {
    if(page === data[0].allpage){
      setshow(false);
      console.log("结束记录",true,"../log/question3.log");
      //保存log文件
  ...
  const showunity = (page) =>{
    if(page === 1){
      ...
      return <MainPageUnitythree data = {data[0]} page = {page} show={show} />
    }
  }
