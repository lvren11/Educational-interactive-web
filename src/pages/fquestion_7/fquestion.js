...
import Intro from '../../component/Mainpage_7/introduce';
import MainPage from '../../component/Mainpage_7/mainpage';
import MainPageUnity from '../../component/Mainpage_7/mainpage_1';
import MainPageUnitytwo from '../../component/Mainpage_7/mainpage_2';
import data from '../../../mock/data/seventh.json';
...
export default function Fquestion() {
  ...
  const handleNext = (page) => {
    if(page === data[0].allpage){
      setshow(false);
      console.log("结束记录",true,"../log/question7.log");
      //保存log文件
